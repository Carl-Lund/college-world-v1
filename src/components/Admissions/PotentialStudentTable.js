...
function createTable(students, sort, props, initial, final) {
    ...
    for (let i = initial; i < final; i++) {
        table.push(<PotentialStudentBubble student = {studentsArray[i]} studentNumber = {Object.keys(props.everything.students).find(key => props.everything.students[key] === studentsArray[i])} studentSwitch = {props.studentSwitch}/>)
    }
