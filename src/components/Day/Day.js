    ...
    render() {
        return (
            <div className="container">
                ...
                <button className="btn btn-default" id="playButton" onClick={this.playPressed}><span className="sr-only">Play</span><img src="https://image.flaticon.com/icons/svg/27/27223.svg" height="15" width="15"/></button>&nbsp;
