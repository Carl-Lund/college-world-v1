    ...
    render() {
        return (
            <div className="container">
                ...
                <button className="btn btn-default" id="playButton" onClick={this.playPressed}><span className="sr-only">Play</span><img alt="play" src="https://image.flaticon.com/icons/svg/27/27223.svg" height="15" width="15"/></button>&nbsp;
                <button className="btn btn-default" id="pauseButton" onClick={this.pausePressed}><span className="sr-only">Pause</span><img alt="pause" src="https://image.flaticon.com/icons/svg/151/151859.svg" height="15" width="15"/></button>&nbsp;
                <button className="btn btn-default" id="ffButton" onClick={this.ffPressed}><span className="sr-only">Fast Forward</span><img alt="fastforward" src="https://image.flaticon.com/icons/svg/254/254422.svg" height="15" width="15"/></button>&nbsp;
